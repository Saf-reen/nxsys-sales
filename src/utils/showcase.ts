...
export const heroSlides = [
  {
    ...
    subheadline: 'High-performance laptops and desktops built for productivity, speed, and scalability.',
...
export const categoryBrandStrip = {
  ...
  description: 'We bring you advanced procurement-ready solutions by partnering with leading global technology brands.',
