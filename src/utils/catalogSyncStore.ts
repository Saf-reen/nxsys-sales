...
export const getCatalogSyncVersion = (): string => {
  if (typeof window === 'undefined') return '';
  return window.localStorage.getItem(CATALOG_SYNC_KEY) || '';
};

export const touchCatalogSync = (): string => {
  if (typeof window === 'undefined') return '';
...
const catalogSyncStore = { CATALOG_SYNC_KEY, CATALOG_SYNC_EVENT, getCatalogSyncVersion, touchCatalogSync };
